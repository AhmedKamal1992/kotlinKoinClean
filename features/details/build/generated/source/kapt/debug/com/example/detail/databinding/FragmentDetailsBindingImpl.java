...
public class FragmentDetailsBindingImpl extends FragmentDetailsBinding implements com.example.detail.generated.callback.OnRefreshListener.Listener, com.example.detail.generated.callback.OnClickListener.Listener {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewModelIsLoading((androidx.lifecycle.LiveData<com.example.repository.utils.Resource.Status>) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModelIsLoading(androidx.lifecycle.LiveData<com.example.repository.utils.Resource.Status> ViewModelIsLoading, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        com.example.repository.utils.Resource.Status viewModelIsLoadingGetValue = null;
        ...
        androidx.lifecycle.LiveData<com.example.repository.utils.Resource.Status> viewModelIsLoading = null;
